...
// ⚠️ 키의 섹션 id는 반드시 src/config/sections.ts 의 SECTIONS id 와 일치해야 함.
//    섹션/항목 이름을 바꾸면 이 표도 같이 고칠 것 (안 그러면 견적으로 안 넘어감).
export const CHECKLIST_TO_ESTIMATE: Record<string, { category: string; name: string; unit: string; unitPrice: number }> = {
  ...
  // 창호 (windows)
  'windows-창호 (샷시)': { category: '창호', name: '창호 (샷시)', unit: '좌', unitPrice: 500000 },
  'windows-폴딩도어': { category: '창호', name: '폴딩도어', unit: '개', unitPrice: 800000 },
  // 욕실 (bathroom)
  ...
  // 설비 (equipment)
  'equipment-시스템 에어컨': { category: '설비', name: '시스템 에어컨', unit: '대', unitPrice: 1500000 },
  // 목공 (carpentry)
  ...
  // 조명 (lighting)
  'lighting-조명 (기본)': { category: '조명', name: '조명 (기본)', unit: '식', unitPrice: 100000 },
  'lighting-조명 (하이엔드)': { category: '조명', name: '조명 (하이엔드)', unit: '식', unitPrice: 300000 },
  // 필름 (film)
  'film-필름 시공': { category: '필름', name: '필름 시공', unit: '평', unitPrice: 50000 },
  // 타일 (tile)
  'tile-타일 시공': { category: '타일', name: '타일 시공 (벽)', unit: '평', unitPrice: 100000 },
  // 탄성코트 (elastic)
  'elastic-탄성코트': { category: '마감', name: '탄성코트', unit: '평', unitPrice: 15000 },
  // 바닥재 (flooring)
  ...
  // 도배 (wallpaper)
  'wallpaper-도배 시공': { category: '도배', name: '도배', unit: '평', unitPrice: 35000 },
  'wallpaper-도배 종류:합지': { category: '도배', name: '합지 도배', unit: '평', unitPrice: 25000 },
  'wallpaper-도배 종류:실크 (기본)': { category: '도배', name: '실크 도배', unit: '평', unitPrice: 40000 },
  'wallpaper-도배 종류:실크 프리미엄 (디아망 등)': { category: '도배', name: '실크 프리미엄 도배', unit: '평', unitPrice: 55000 },
  // 가구 (furniture)
  'furniture-맞춤 가구': { category: '가구', name: '맞춤 가구', unit: '식', unitPrice: 1000000 },
  // 철물 / 기타 설비 (hardware)
  'hardware-번호키 (도어락)': { category: '기타', name: '번호키', unit: '개', unitPrice: 200000 },
  'hardware-인터폰': { category: '기타', name: '인터폰', unit: '개', unitPrice: 150000 },
  'hardware-외부 실리콘': { category: '기타', name: '외부 실리콘', unit: '건', unitPrice: 100000 },
  // 입주 청소 및 기타 (finishing)
